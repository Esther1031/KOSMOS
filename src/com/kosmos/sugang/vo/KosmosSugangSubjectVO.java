...
// 과목조회 
public class KosmosSugangSubjectVO {
	...
	public KosmosSugangSubjectVO() {
		super();
	}
	public KosmosSugangSubjectVO(String sb_num, String sb_group, String sb_code, String sb_type, String sb_name,
			String sb_creditunit, String sb_grade, String sb_year, String sb_semester, String sb_teacher,
			String sb_maxstu, String sb_day, String sb_time, String sb_timetable, String sb_beforeyn,
			String sb_beforename, String sb_insdate, String sb_upddate, String sb_delyn) {
		super();
		this.sb_num = sb_num;
		this.sb_group = sb_group;
		this.sb_code = sb_code;
