							...
							<table>
								<tr>
									...
									<td class="line2" colspan="3">
										<input type="text" name="tename" id="tename" value="${ data.ms_name }">
									</td>
								</tr>
								<tr>
									<th colspan="1">이메일</th>
									<td colspan="3">
										<input type="text" name="temail" id="temail" value="${ data.ms_id }">
									</td>
								</tr>
								<tr>
									<th colspan="1">핸드폰 번호</th>
									<td colspan="3">
										<input type="text" name="tecp" id="tecp" value="${ data.ms_cp }">
									</td>
								</tr>	
								<tr>
									<th>우편번호</th>
									<td>
										<input type="text" name="me_zipcode" id="me_zipcode" style="width:50px" maxlength="6"  value="${ data.ms_zipcode }">
									</td>
									<th>도로명 주소</th>
									<td>
										<input type="text" name="me_doro" id="me_doro" style="width:250px" value="${ data.ms_doro }">
									</td>
								</tr>
							</table>
