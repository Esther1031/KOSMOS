	    ...
	    <div class="content">	
	        ...
	        <!-- ============================== 본문 ============================== -->
		   	<div style="width:96%;">
				...
				%>
				<div>
					<form name="boardUpdateForm" id="boardUpdateForm" style="color:#043874;">
						...
						<div class="all">
							...
							<table border=1>
								<tr>
									...
									<td><input type="text" name="bo_num" id="bo_num" style= "border: none;" value="<%= bvo.getBo_num() %>" readonly/></td>
								</tr>
								<tr>
									<td class="mem">말머리</td>
									<td><input type="text" name="bo_header" id="bo_header" style="border: none;" value="<%=  bvo.getBo_header() %>" readonly/></td>
								</tr>
								<tr>
									<td class="mem">제목</td>
									<td>
									<input type="text" name="bo_subject" id="bo_subject" style="border: none;" value="<%= bvo.getBo_subject() %>" style="width:100px"  readonly/>
								</td>
								</tr>
								<tr>
									<td class="mem">회원번호</td>
									<td><input type="text" name="ms_num" id="ms_num" style="border: none;" value="<%=  bvo.getMs_num() %>" readonly/></td>
								</tr>
								<tr>
									<td class="mem">내용</td>
									<td>
										<textarea name="bo_contents" id="bo_contents" rows="5" cols="50" style="border: none;" ><%= bvo.getBo_contents() %>					
										</textarea>
									</td>
								</tr>
								<tr>
									...
									border="1" width="40" height="50" alt="image" style="border: none;">
								...
								<tr>
									<td class="mem">등록일</td>
									<td> 
									<input type="text" name="bo_insdate" id="bo_insdate" style= "border: none;" value="<%= bvo.getBo_insdate() %>" readonly />		      
									</td>
								</tr>	 
								<tr>
									<td class="mem">수정일</td>
									<td> 
										<input type="text" name="bo_upddate" id="bo_upddate" style="border: none;" value="<%= bvo.getBo_upddate() %>" readonly />		      
									</td>
								</tr>
								<tr>
									<td class="mem">비밀번호</td>
									<td>
									<input type="text" name="bo_pw" id="bo_pw" style="border: none;" placeholder="비밀번호를 입력하세요."/>
