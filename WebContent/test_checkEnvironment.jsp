...
//======================================================================================================
	...
	var info = "<h2>웹 브라우저 접속 환경 확인</h2><hr><br>";
			   info += "<div><p>브라우저 이름 >>> :" +navigator.appName + "</p>";
	...
	if(is_mobile) {
		document.write("<p>현재 모바일로 접속중 입니다.</p></div>");
	} else {
		document.write("<p>현재 PC로 접속중 입니다.</p></div>");
	}
...
<body>
<p style="height: 40px">
<table><tr><td><button class="button" type="button" id="close">닫기</button></td></tr>
</table></body>
</html>